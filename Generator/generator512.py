"""
Generator that takes nz dimensional noise and generates 512 x 512 x 3 image
...
class Generator(nn.Module):
    def __init__(self, config_file):
        ...
        self.main = nn.Sequential(
            # block 0
            nn.ConvTranspose2d(nz, ngf * 32, 4, stride=2, padding=1, bias=False),
            ...
            # block 4
            nn.ConvTranspose2d(ngf * 16, ngf * 32, 4, stride=2, padding=1, bias=False),
            nn.BatchNorm2d(ngf * 32),
            nn.LeakyReLU(inplace=True),
